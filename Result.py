...
with open( "in_out/Result.dat", 'w') as ouf:
    ...
    ouf.write(  str('N\t') + str('K_0\t') + str('K_cut\t') +  str('Z\t') +  str( 'P2              ') + str('P3              ') + str( 'P4\n') ) 
    
    ouf.write( str(m) +  '\t' + str(k_0) + '\t' + str(k_cut) + '\t' + str( "%.3f" % Z(M_sub)) + '\t' +  str("{:.3e}".format(p_2))+ '\t'+ str("{:.3e}".format(p_3)) +'\t'  + str("{:.3e}".format(p_4)) + '\n' )